    ...
    fetch('./controllers/couponController.php', {
        ...
        .then(data => {
            if (data.status === 'success') {
                document.querySelector('h6[name="copoun"]').innerHTML = 'Coupon Discount';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const additionalAddressFields = document.getElementById('additionalAddressFields');
    const hiddenAddressField = orderForm.querySelector('input[name="order_address"]');
