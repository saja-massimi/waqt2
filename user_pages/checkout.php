                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="custom-select" disabled>
                                <option value="irbid" <?= $userData['user_country'] == 'irbid' ? 'selected' : '' ?>>Irbid</option>
                                <option value="jarash" <?= $userData['user_country'] == 'jarash' ? 'selected' : '' ?>>Jarash</option>
                                <option value="ajloun" <?= $userData['user_country'] == 'ajloun' ? 'selected' : '' ?>>Ajloun</option>
                                <option value="aqaba" <?= $userData['user_country'] == 'aqaba' ? 'selected' : '' ?>>al-'Aqaba</option>
                                <option value="madaba" <?= $userData['user_country'] == 'madaba' ? 'selected' : '' ?>>Madaba</option>
                                <option value="mafraq" <?= $userData['user_country'] == 'mafraq' ? 'selected' : '' ?>>al-Mafraq</option>
                                <option value="zarqa" <?= $userData['user_country'] == 'zarqa' ? 'selected' : '' ?>>al-Zarqa</option>
                                <option value="amman" <?= $userData['user_country'] == 'amman' ? 'selected' : '' ?>>Amman</option>
                                <option value="balqa" <?= $userData['user_country'] == 'balqa' ? 'selected' : '' ?>>al-Balqa</option>
                                <option value="karak" <?= $userData['user_country'] == 'karak' ? 'selected' : '' ?>>al-Karak</option>
                                <option value="tafileh" <?= $userData['user_country'] == 'tafileh' ? 'selected' : '' ?>>al-Tafilah</option>
                                <option value="maan" <?= $userData['user_country'] == 'maan' ? 'selected' : '' ?>>Ma'an</option>
                            </select>
                        </div>
                    ...
                    <form class="mb-30" action="">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <form action="./controllers/couponController.php" action="POST">
